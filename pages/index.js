            ...
            <div>
              ...
              <Command variantStyle="" variant={
                <div className={styles.button}>Press <kbd>ctrl</kbd> <kbd>K</kbd> to start
                  ...
                  >
                    <path
                      d="M20 11.603c0-.335-.147-.687-.376-.907l-5.303-5.304c-.262-.261-.572-.392-.867-.392-.727 0-1.209.498-1.209 1.16 0 .376.155.662.384.883l1.863 1.863 1.684 1.56-1.757-.097H5.283c-.768 0-1.283.498-1.283 1.234 0 .735.515 1.225 1.283 1.225h9.136l1.765-.09-1.692 1.553-1.863 1.855c-.22.229-.384.515-.384.883 0 .662.482 1.168 1.21 1.168.294 0 .596-.13.857-.384l5.312-5.311c.229-.221.376-.572.376-.9z" />
                  </svg>
                </div>
              } />
            </div>
